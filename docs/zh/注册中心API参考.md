...
- 请求参数
  ...
  **表1** body参数列表
    ...
    |------------|------|-----------------|-----------------------------------------------|-----|------|
    | agentCards | 是    | array_reference | 当前只支持单个AgentCard的注册，详细请参见表2。 | -   | -    |
  ...
  **表2** AgentCard对象的参数列表
    ...
    | provider            | 是    | reference       | 详细请参见表4。                                       | -   | 提供商信息。        |
    | skills              | 是    | array_reference | 最大数量：100 个技能；每个技能的 JSON 序列化后最大长度：4096 字符；详细请参见表7。 | -   | 技能列表。         |
    | capabilities        | 是    | reference       | 详细请参见表5。                                   | -   | AgentCard能力项。 |
    | supportedInterfaces | 是    | array_reference | 1~3个列表，详细请参见表3。                               | -   | 支持的协议。        |

  **表3** AgentInterface对象的参数列表
  ...
  **表5** AgentCapabilities对象的参数列表
    ...
    | extensions        | 否    | array_reference | 最大数量：10 个扩展；每个扩展的 JSON 序列化后最大长度：512 字符；详细请参见表6。 | -     | 支持的扩展能力列表，用于声明 Agent 实现的 A2A 协议扩展特性。                                                  |

  **表6** AgentExtension对象的参数列表
...
- 响应参数
  ...
  | 参数名称 | 类型              | 值域 | 默认值 | 描述         |
  |------|-----------------|----|-----|--------------|
  | agentCards | array_reference | -  | -   | 符合要求的Agent列表。 |
